...
void DefaultSceneLayer::_CreateScene()
{
	...
	if (loadScene && std::filesystem::exists("scene.json")) {
		...
		// Load in the meshes
		MeshResource::Sptr ladybugMesh = ResourceManager::CreateAsset<MeshResource>("NewLadybug.obj");
		...
		Texture2D::Sptr    ladybugTex    = ResourceManager::CreateAsset<Texture2D>("textures/LadybugUV.png");
		Texture2D::Sptr    backgroundTex = ResourceManager::CreateAsset<Texture2D>("textures/BackgroundUV.png");
...
#pragma endregion 
		...
		{
			ladybugMaterial->Name = "Ladybug";
			ladybugMaterial->Set("u_Material.AlbedoMap", ladybugTex);
			ladybugMaterial->Set("u_Material.NormalMap", normalMapDefault);
			ladybugMaterial->Set("u_Material.Shininess", 0.5f);
		}

		Material::Sptr backgroundMaterial = ResourceManager::CreateAsset<Material>(deferredForward);
		{
			backgroundMaterial->Name = "background";
		...
		{
			camera->SetPostion({ -0.6, 3.85, 6.37 });
			camera->SetRotation({63.796, 0, -173.31});
		...
		{
			ladybug->SetPostion(glm::vec3(-0.7f, 0.4f, 4.2f));
			ladybug->SetRotation(glm::vec3(90.0f, 0.0f, 72.0f));
			ladybug->SetScale(glm::vec3(0.5));
			ladybug->Add<JumpBehaviour>();
		...
		{
			background->SetPostion(glm::vec3(-0.01f, -7.71f, 1.0f));
			background->SetRotation(glm::vec3(90.0f, 0.0f, -180.0f));
			background->SetScale(glm::vec3(1.45f, 1.45f, 1.0f));
			...
			TriggerVolume::Sptr trigger = background->Add<TriggerVolume>();
			trigger->SetFlags(TriggerTypeFlags::Statics | TriggerTypeFlags::Kinematics);
			trigger->AddCollider(BoxCollider::Create(glm::vec3(1.0f)));

			background->Add<TriggerVolumeEnterBehaviour>();
		}
		...
		GameObject::Sptr shadowCaster = scene->CreateGameObject("Shadow Light");
		{
			...
			shadowCaster->SetPostion(glm::vec3(12.19f, 3.0f, 5.0f));
			shadowCaster->SetRotation(glm::vec3(40.319f, 0.0f, 135.0f));
			shadowCaster->SetScale(glm::vec3(3.68f, 4.47f, 1.0f));
